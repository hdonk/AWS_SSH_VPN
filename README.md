...
# Run up the SSH/VPN/Proxy server
...
# How to use the VPN service from a Web Browser
Putty with tunneling
ConnectBot
FoxyProxy for Chrome/Firefox
Windows proxy network config
SocksHttp
